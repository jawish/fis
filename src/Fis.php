...
/**
 * Application interface for flights in/out of Hulhule' 
 * (Ibrahim Nasir International Airport) by scraping the flight information
 * service (fis.com.mv).
 *
 * Usage example:
 * $flights = new FlightInfo();
 * $flights->getInfo( 'arrivals', 'all' );
 * $flights->sortBy( 'estimated' );
 * echo $flights->updateAt;
 * print_r( $flights->flights );
 *
 *
 *
...
/**
 * Processes flight information data file and makes it available as easily
 * accessible properties of an object
 *
 * @package 	flightinfo
 * @author 		Jawish Hameed <jaa@jawish.org>
 * @version 	0.3 (2015-09-04)
